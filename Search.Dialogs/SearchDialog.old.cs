namespace Search.Dialogs
{
    ...
    [Serializable]
    public abstract class SearchDialogOld : IDialog<IList<SearchHit>>
    {
        ...
        public SearchDialogOld(ISearchClient searchClient, SearchQueryBuilder queryBuilder = null, PromptStyler searchHitStyler = null, bool multipleSelection = false)
        {
        ...
        private async Task RunGenericPyfetch(string url1, string args, IDialogContext context)
        {
            ...
            try
            {
                ...
                {
                    var resultList = JsonConvert.DeserializeObject<List<RootObjectOld>>(result);
        ...
        void parseResultSet(List<RootObjectOld> roots, IDialogContext context)
        {
            StringBuilder sb = new StringBuilder();

            foreach (RootObjectOld root in roots)
            {
    ...
    public class RootGoogleObjectOld
    {
    ...
    public class RootBookObjectOld
    {
        public string img { get; set; }
        public string description { get; set; }
    ...
    public class RootObjectSOld
    {
        public string venue_id { get; set; }
        public string name { get; set; }
        public List<ReviewOld> reviews { get; set; }
    ...
    public class RootCardObjectOld
    {
        public string img { get; set; }
        public string description { get; set; }
        public string title { get; set; }
